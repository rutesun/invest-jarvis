...
|------|------|--------|------|----|--------|
| 2026-07-24 | feat | Draft | LLM 모델 설정 일원화 — config.yaml llm 섹션 단일 소스, GPT-5.6 전환(terra/luna/sol), --provider·STOCK_REPORT_* env 삭제, StageLLMConfig 통합 | - | [llm-model-config-unification.md](llm-model-config-unification.md) |
