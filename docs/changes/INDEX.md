...
|------|------|--------|------|----|--------|
| 2026-07-27 | fix | Draft | Daily Report OpenAI strict schema 회귀 수정 — ThemeMapping dict→groups 배열, strict 계약 테스트, 카테고리 alias 6종 | #53 | [daily-report-strict-schema-fix.md](daily-report-strict-schema-fix.md) |
