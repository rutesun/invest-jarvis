...
|------|------|--------|------|----|--------|
| 2026-07-16 | feat | Draft | jarvis brief — 일일 포트 액션 종합 CLI (+ PortfolioPipeline 제거, exit_rules SMA 버그픽스, SMA_LONG 전환국면 강등, KRX 영숫자 코드 인식) | - | [jarvis-brief.md](jarvis-brief.md) |
