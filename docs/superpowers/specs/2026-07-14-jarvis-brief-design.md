...
| D11 | SMA_LONG 전환 국면 강등 (2026-07-15~16) | 실사용 피드백: 전환(턴어라운드) 선취매 종목(PGY·TEM — 종가>SMA150, SMA200 아래)이 "청산"으로 오분류. 1차 구현은 "가격>150선 && SMA150 상승(21거래일 대비)"이었으나, 실데이터 검증 결과 두 종목 모두 SMA150이 아직 하락 중이라 미발화 → 사용자 결정으로 **가격 회복만으로 강등**(종가>SMA150이면 SMA200 이탈을 강→약). SMA150 기울기는 판정에 안 쓰고 "상승/하락 중(미확인)"으로 근거에 병기. 근거: 청산 신호의 목적(추세 붕괴 포착)은 이미 지난 국면이고, SMA150 이탈은 여전히 강신호로 방어선 유지. 기각 대안: 기울기 조건 유지(원전 충실하나 보유자 관점에서 라벨이 늦음), strategy 태그(2차로 연기) |
