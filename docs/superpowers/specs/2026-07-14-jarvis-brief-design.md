...
| D11 | SMA_LONG 전환 국면 강등 (2026-07-15) | 실사용 피드백: 전환(턴어라운드) 선취매 종목(PGY·TEM — 종가>SMA150, SMA150 상승, SMA200 아래)이 "청산"으로 오분류. 와인스타인 Stage 기준선은 30주선(SMA150)이므로, 종가>SMA150 && SMA150 상승(21거래일 대비)이면 SMA200 이탈을 강→약으로 강등 + "전환 시도 국면" 표기. SMA150 이탈은 여전히 강. 기각 대안: 종목별 strategy 태그(스키마 복잡도, 2차로 연기) |
